...
mod tests {
    ...
    fn table_bg_resolves() {
        ...
        assert!(
            light.resolve_bg("table_bg").is_some(),
            "light scheme should resolve table_bg"
        );
        let dark = ColorScheme::dark();
        assert!(
            dark.resolve_bg("table_bg").is_some(),
            "dark scheme should resolve table_bg"
        );
    }
    ...
    fn theme_preference_unknown_falls_back_to_system() {
        assert_eq!(
            "unknown".parse::<ThemePreference>().unwrap(),
            ThemePreference::System
        );
        assert_eq!(
            "".parse::<ThemePreference>().unwrap(),
            ThemePreference::System
        );
    }
    ...
    fn theme_preference_light_ignores_system_darkness() {
        assert_eq!(
            ThemePreference::Light.resolve(false).background,
            ColorScheme::light().background
        );
        assert_eq!(
            ThemePreference::Light.resolve(true).background,
            ColorScheme::light().background
        );
    }
    ...
    fn theme_preference_dark_ignores_system_darkness() {
        assert_eq!(
            ThemePreference::Dark.resolve(false).background,
            ColorScheme::dark().background
        );
        assert_eq!(
            ThemePreference::Dark.resolve(true).background,
            ColorScheme::dark().background
        );
    }
    ...
    fn theme_preference_system_follows_os() {
        assert_eq!(
            ThemePreference::System.resolve(false).background,
            ColorScheme::light().background
        );
        assert_eq!(
            ThemePreference::System.resolve(true).background,
            ColorScheme::dark().background
        );
    }
}
